angular.module("portfolio").service('aboutService', function () {
    ...
    this.itensSection = [
        ...
        {nome: "Capacidade de inovar", porcentagem: 70, section: 3}
    ];
